...
x <- read_csv(file = 'https://raw.githubusercontent.com/gitcnk/Data/master/colleges2016.csv')
...
ui <- fluidPage(
  ...
  titlePanel("US Colleges 2016"),
  
  sidebarPanel(width = 3,
               
               h5(a('Data from Mike Chapple, Notre Dame University.')), # Level (size) 5 heading
  ...
  output$Pop <- renderPlot({
    ggplot(mydata) +
      ...
      labs(title = 'Distribution of the Selected Variable',
           subtitle = 'Data Source: US Colleges 2016')
  })
